...
//		opt.addPreference("security.cert_pinning.enforcement_level", 0);
//		opt.addPreference("security.enterprise_roots.enabled", true);
		
		
//		String profile = new FirefoxProfile();
//		{
...
//		driver.findElement(By.xpath("(//span[text()='Create'])[2]")).click();
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//div[contains(@class,'ua-firefox ProseMirror')]//p[1]) | (//div[contains(@class,'ua-chrome ProseMirror')]//p[1])")).click();
		...
		Thread.sleep(6000);
		driver.findElement(By.xpath("(//div[contains(@class,'ua-firefox ProseMirror')]//p[1]) | (//div[contains(@class,'ua-chrome ProseMirror')]//p[1])")).click();
		driver.findElement(By.xpath("(//div[contains(@class,'ua-firefox ProseMirror')]//p[1]) | (//div[contains(@class,'ua-chrome ProseMirror')]//p[1])")).sendKeys("This is subtask Description");
